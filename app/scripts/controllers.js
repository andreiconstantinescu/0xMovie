...
define(['angular'], function (angular) {
	...
	return angular.module('MovieScribe.Controllers', [])
		.controller('MainController', ['$scope', '$rootScope', '$location', '$timeout', '$http', 'AuthenticationService', 'OMDB', 'MovieScribeAPI', 'Trailers', function ($scope, $rootScope, $location, $timeout, $http, AuthenticationService, OMDB, MovieScribeAPI, Trailers) {
